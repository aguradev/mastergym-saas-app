    ...
    return [
        {
            ...
            copyright: "© Copyright 2024, All Rights Reserved by Gym Master"
        },
    ]
}
...
onMounted(async () => {
    const data = await fetchFooterItems();
...
<template>
    ...
    <article>
        <slot />
        <TenantFooter :gym-title="FooterData.gymTitle" :brief-text="FooterData.briefText" :menus="FooterData.menus"
            :twitter="FooterData.twitter" :facebook="FooterData.facebook" :instagram="FooterData.instagram"
