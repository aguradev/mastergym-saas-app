    ...
    <section class="auth_section">
        ...
        <form @submit.prevent="submitLogin" autocomplete="off">
            <div class="flex flex-col gap-6">
                <div class="flex flex-col gap-2">
                    ...
                    <InputElement
                        ...
                        inputType="text"
                        inputId="usernameEmailInput"
                        inputPlaceholder="example@gmail.com"
                    />
                    <span
                        class="text-danger-300"
                        v-if="errorMessages.validationMessage.email"
                    >
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <span
                        class="text-danger-300"
                        v-if="errorMessages.validationMessage.password"
                    >
            ...
            <div class="flex items-center mt-12">
                <Button
                    :pt="{
                        root: 'flex justify-center gap-x-2 items-center bg-surface-600 px-4 text-base py-4 rounded-xl text-white hover:bg-surface-700 w-full',
                    }"
                    type="submit"
