...
import FeaturePlanForms from "@components/central-pages/dashboard/subscription/forms/FeaturePlanForm.vue";
...
<template>
    <Dialog
        ...
        modal
        header="Feature Create"
    >
        <FeaturePlanForms
            @action-feature-form="handlerCreateFeature"
