...
import UploadImage from "@components/central-pages/landingPage/UploadImage.vue";
...
<template>
    ...
    <div class="h-screen md:flex w-full">
        <div
            class="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-blue-900 to-blue-500 i justify-around items-center hidden"
        >
            <div>
        ...
        <div
            class="flex w-1/2 overflow-scroll overflow-x-hidden justify-center py-5 h-full pt-[0px]items-center bg-white"
        >
            <form @submit.prevent="submit" class="bg-white w-full h-min px-20">
                <h1 class="text-gray-800 font-bold text-2xl mt-20 mb-1">
                    Lets Setup Your Account!
                </h1>
                <p class="text-sm font-normal text-gray-600 mb-7">
                    Setting Up Your Gym Configuration!
                </p>
                    ...
                    <div class="w-full px-3">
                        <div class="mb-5">
                            ...
                            <input
                                ...
                                name="gName"
                                id="gName"
                                placeholder="Insert your gym name here!"
                                class="w-full rounded-md border-2 -2-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                            />
                        </div>
                    </div>
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input
                                ...
                                name="fName"
                                id="fName"
                                placeholder="Where your gym is located"
                                class="w-full rounded-md border-2 border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                            />
                        </div>
                    </div>
                ...
                <div>
                    <button
                        class="w-full mt-5 hover:shadow-form rounded-md bg-[#6A64F1] py-3 px-8 text-center text-base font-semibold text-white outline-none tracking-wider"
                    >
                        I'M READY TO START
                    </button>
                </div>
