...
<template>
    ...
    <form @submit.prevent="submit">
        ...
        >
            <div
                class="card shadow-xl bg-white flex-row w-11/12 md:w-2/5 rounded-2xl text-black p-5"
            >
                <div
                    id="title"
                ...
                >
                    <div>
                        ...
                        <label class="text-sm"
                            >I Confirm that the information displayed above is
                            true.</label
                        >
                    </div>
                    <div>
                        <input class="inline-block mr-2" type="checkbox" />
                        <label class="text-sm"
                            >I Agree to the Terms and Condition of the Gym
