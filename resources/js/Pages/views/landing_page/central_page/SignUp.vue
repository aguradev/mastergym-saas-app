...
<template>
    ...
    <div class="h-screen md:flex">
        ...
        <div class="flex md:w-1/2 justify-center py-5 items-center bg-white">
            <form class="bg-white w-[600px] px-20">
                <h1 class="text-gray-800 font-bold text-2xl mb-1">Register Your Account!</h1>
                <p class="text-sm font-normal text-gray-600 mb-7">The fist of few simple steps to get your app running!</p>
