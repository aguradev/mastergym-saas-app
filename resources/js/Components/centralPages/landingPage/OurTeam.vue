...
<template>
    ...
    <!-- Page Container -->
    <div class="flex items-center justify-center min-h-screen bg-white py-10">
                ...
                <div class="container max-w-7xl px-4">
                    ...
                    <div class="flex flex-wrap justify-center text-center mb-24">
                        <div class="w-full lg:w-6/12 px-4">
                            ...
                            <!-- Description -->
                            <p class="text-gray-700 text-lg font-light">With over 100 years of combined experience, we've got a well-seasoned team at the helm.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full md:w-6/12 lg:w-3/12 mb-6 px-6 sm:px-6 lg:px-4">
                            <div class="flex flex-col">
                                ...
                                <div class="text-center mt-6">
                                    <!-- Name -->
                                    <h1 class="text-gray-900 text-xl font-bold mb-1">Tranter Jaskulski</h1>

                                    <!-- Title -->
                                    <div class="text-gray-700 font-light mb-2">Founder & Specialist</div>
                        ...
                        <div class="w-full md:w-6/12 lg:w-3/12 mb-6 px-6 sm:px-6 lg:px-4">
                            <div class="flex flex-col">
                                ...
                                <div class="text-center mt-6">
                                    <!-- Name -->
                                    <h1 class="text-gray-900 text-xl font-bold mb-1">Denice Jagna</h1>

                                    <!-- Title -->
                                    <div class="text-gray-700 font-light mb-2">Tired & M. Specialist</div>
                        ...
                        <div class="w-full md:w-6/12 lg:w-3/12 mb-6 px-6 sm:px-6 lg:px-4">
                            <div class="flex flex-col">
                                ...
                                <div class="text-center mt-6">
                                    <!-- Name -->
                                    <h1 class="text-gray-900 text-xl font-bold mb-1">Sara Paulo</h1>

                                    <!-- Title -->
                                    <div class="text-gray-700 font-light mb-2">general marketing</div>
