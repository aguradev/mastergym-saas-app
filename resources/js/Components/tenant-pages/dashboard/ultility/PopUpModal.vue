...
<template>
    ...
    }" modal header="Preview Footer Website Layout">

        <div>
            <img :src="img" alt="">
            <p class="text-sm pt-2">*This is only a static preview of the default layout, and does not represent
                the
                current content that is displayed on the live website*</p>
        </div>
    </Dialog>
</template>