...
<template>
    <div class="h-screen grid justify-content-center justify-items-center place-content-center">
        <div class="w-[600px] grid justify-content-center justify-items-center place-content-center">
            <div class="bg-surface-600 p-8 w-full text-center rounded-md">
                <p class="text-4xl font-medium">Registration</p>
            </div>
            <div class="w-full bg-white my-4 h-[2px]"></div>
            <form
                action="#"
                autocomplete="off"
            >
