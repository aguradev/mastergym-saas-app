    ...
    >
        <div>
            ...
            >
                <InputText
                    inputId="title"
                    inputPlaceholder="Title of your Hero here!"
                    inputName="title_input"
            ...
            >
                <InputText
                    inputId="btnLeft"
                    inputPlaceholder="Left button text of your Hero here!"
                    inputName="left_button"
                    v-model:inputValue="btnLeft"
                />
                <ValidationMessage
                    v-if="form.errors.btnLeft"
                    :caption="form.errors.btnLeft"
                />
            </InputGroup>
            <InputGroup
                label="Hero Right Button"
                labelFor="right-button"
            >
                <InputText
                    inputId="btnRight"
                    inputPlaceholder="Right button text of your Hero here!"
                    inputName="right_button"
                    v-model:inputValue="btnRight"
                />
                <ValidationMessage
                    v-if="form.errors.btnRight"
                    :caption="form.errors.btnRight"
                />
            </InputGroup>
            <InputGroup
                label="Hero Background Image"
                labelFor="background_input"
            >
                <InputFile
                    inputId="image"
                    inputType="file"
