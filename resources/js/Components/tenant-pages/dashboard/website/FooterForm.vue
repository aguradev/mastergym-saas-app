    ...
    <div class="grid grid-cols-1 pt-6 px-8">
        ...
        <form action="#" autocomplete="off" @submit.prevent="editHandler">
            <div class="grid grid-cols-2 gap-10 pt-5">
                <div id="left">
                    <InputGroup label="Gym Title" label-for="gymTitle">
                        <InputText inputId="gymTitle" input-placeholder="Your gym title goes here"
                            input-name="gym_title_input" v-model:inputValue="gymTitle" />
                        <ValidationMessage v-if="form.errors.gymTitle" :caption="form.errors.gymTitle" />
                    </InputGroup>
                    <InputGroup label="Brief Text" label-for="briefText">
                        <InputTextArea inputId="briefText" input-placeholder="Your footer brief text goes here"
                            input-name="gym_text_input" v-model:inputValue="briefText" />
                        <ValidationMessage v-if="form.errors.gymTitle" :caption="form.errors.gymTitle" />
                    </InputGroup>
                    <InputGroup label="Gym Icon" label-for="gymIcon">
                        <InputFile inputId="gymIcon" inputType="file" input-name="gym_icon_input"
                            @update:inputValue="(file) => { form.gymIcon = file; }" />
                        <p class="pt-2">Currently Used Icon</p>
                    </InputGroup>
                    <PreviewImage :key="imgComponentKey" :img="imgUrl" />
                    <ValidationMessage v-if="form.errors.gymIcon" :caption="form.errors.gymIcon" />
                </div>
                <div id="right">
                    <InputGroup label="Footer Menus" label-for="menus">
                        <div class="grid grid-cols-5 grid-rows-1 gap-4">
                            <div>
                                <InputText inputId="menus1" input-placeholder="Menu 1" input-name="footer_menu_input1"
                                    v-model:inputValue="menus1" />
                                <ValidationMessage v-if="form.errors.menus1" :caption="form.errors.menus1" />
                            </div>
                            <div>
                                <InputText inputId="menus2" input-placeholder="Menu 2" input-name="footer_menu_input2"
                                    v-model:inputValue="menus2" />
                                <ValidationMessage v-if="form.errors.menus2" :caption="form.errors.menus2" />
                            </div>
                            <div>
                                <InputText inputId="menus3" input-placeholder="Menu 3" input-name="footer_menu_input3"
                                    v-model:inputValue="menus3" />
                                <ValidationMessage v-if="form.errors.menus3" :caption="form.errors.menus3" />
                            </div>
                            <div>
                                <InputText inputId="menus4" input-placeholder="Menu 4" input-name="footer_menu_input4"
                                    v-model:inputValue="menus4" />
                                <ValidationMessage v-if="form.errors.menus4" :caption="form.errors.menus4" />
                            </div>
                            <div>
                                <InputText inputId="menus5" input-placeholder="Menu 5" input-name="footer_menu_input5"
                                    v-model:inputValue="menus5" />
                                <ValidationMessage v-if="form.errors.menus5" :caption="form.errors.menus5" />
                            </div>
                        </div>
                    </InputGroup>
                    <InputGroup label="Twitter Link" label-for="twitter">
                        <InputText inputId="twitter" input-placeholder="Your twitter link goes here"
                            input-name="twitter_link_input" v-model:inputValue="twitter" />
                        <ValidationMessage v-if="form.errors.twitter" :caption="form.errors.twitter" />
                    </InputGroup>
                    <InputGroup label="Facebook Link" label-for="facebook">
                        <InputText inputId="facebook" input-placeholder="Your facebook link goes here"
                            input-name="facebook_link_input" v-model:inputValue="facebook" />
                        <ValidationMessage v-if="form.errors.facebook" :caption="form.errors.facebook" />
                    </InputGroup>
                    <InputGroup label="Instagram Link" label-for="instagram">
                        <InputText inputId="instagram" input-placeholder="Your instagram link goes here"
                            input-name="instagram_link_input" v-model:inputValue="instagram" />
                        <ValidationMessage v-if="form.errors.instagram" :caption="form.errors.instagram" />
                    </InputGroup>
