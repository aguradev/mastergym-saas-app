...
<template>
    ...
    <transition name="scaleIn">
        <div class="p-8 border rounded-lg bg-primary-800 border-surface-500 z-[99] min-w-[400px] sm:min-w-[600px] md:min-w-[800px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
            v-if="modalVisible">
