...
<template>
    <div class="bg-gray-50 text-black py-[50px] flex flex-col items-center">
        ...
        <div id="dashboard" class="grid place-items-center w-[100%] mb-10 mt-20">
            <img class="w-[300px] md:w-[60%] lg:w-[50%]" src="/public/assets/images/svg/undraw_data_trends_re_2cdy.svg"
                alt="Dashboard Image" />
        </div>
        <div id="features" class="md:flex justify-evenly gap-x-7 w-[80%] mt-5">
