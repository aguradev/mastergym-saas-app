...
<template>
    <section class="py-10 bg-white sm:pt-8 shadow-lg shadow-black">
        <div
            id="footer"
            class="px-4 mx-auto sm:px-6 max-w-7xl"
        >
                ...
                <div class="col-span-1 md:col-span-1 lg:col-span-1 lg:pr-8">
                    <div>
                        <img
                            ...
                            class="w-[60px] inline"
                        />
                        <p class="text-black box-shadow inline ml-3 text-2xl font-medium align-middle">Gym Master</p>
                    </div>

                    <p class="text-base leading-relaxed text-gray-600 mt-7">We provide the best gym management service for our customers, seamless integration and ease of use is our top priority.</p>
                </div>
            ...
            <hr class="mt-10 mb-10 border-gray-400" />

            <p class="text-sm text-center text-gray-600">© Copyright 2024, Website made by Gym Master</p>
        </div>
    </section>
</template>
