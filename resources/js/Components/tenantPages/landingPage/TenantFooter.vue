            ...
            <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                    <div>
                        ...
                        <p class="text-orange-500 box-shadow inline ml-3 text-2xl font-medium align-middle">Gym Master</p>
                    </div>
                ...
                <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                    <p class="text-sm font-semibold tracking-widest text-orange-400 uppercase">Subscribe to newsletter</p>
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            class="inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-white transition-all duration-200 bg-orange-500 rounded-md hover:bg-orange-600 focus:bg-orange-600"
                        >
                            Subscribe
                        </button>
                    </form>
