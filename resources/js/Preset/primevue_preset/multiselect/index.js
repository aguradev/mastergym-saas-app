export default {
    ...
    label: ({ props }) => ({
        class: [
            ...
            // Color
            {
                "text-primary-500 dark:text-white/80": props.modelValue,
                "text-primary-800 dark:text-primary-200": !props.modelValue,
            },
            "placeholder:text-primary-300 dark:placeholder:text-primary-300",
    ...
    token: {
        class: [
            ...
            "text-primary-700 dark:text-white/70",
    ...
    panel: {
        class: [
            ...
            // Color
            "bg-primary-0 dark:bg-primary-700",
            "text-primary-800 dark:text-white/80",
    ...
    headerCheckbox: {
        ...
        box: ({ props, context }) => ({
            class: [
                ...
                // Colors
                {
                    "border-primary-200 bg-primary-0 dark:border-primary-800 dark:bg-primary-800":
                        !context.checked,
        ...
        box: ({ props, context }) => ({
            class: [
                ...
                // Colors
                {
                    "border-primary-200 bg-primary-0 dark:border-primary-800 dark:bg-primary-800":
                        !context.checked,
                    "border-primary-900 bg-primary-900 dark:border-primary-400 dark:bg-primary-400":
                        context.checked,
                },
    ...
    closeButton: {
        class: [
            ...
            "hover:bg-primary-100 dark:hover:bg-primary-700/80",
    ...
    item: ({ context }) => ({
        class: [
            ...
            {
                "bg-primary-200 dark:bg-primary-600/60 text-primary-700 dark:text-white/80":
                    context.focused && !context.selected,
            },
            {
            ...
            //States
            {
                "hover:bg-primary-100 dark:hover:bg-primary-600/80":
                    !context.focused && !context.selected,
            },
            {
                "hover:text-primary-700 hover:bg-primary-100 dark:hover:text-white dark:hover:bg-primary-600/80":
                    context.focused && !context.selected,
            },
    ...
    itemgroup: {
        class: [
            ...
            // Color
            "text-primary-800 dark:text-white/80",
            "bg-primary-0 dark:bg-primary-600/80",
